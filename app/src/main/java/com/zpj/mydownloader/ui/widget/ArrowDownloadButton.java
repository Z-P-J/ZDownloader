package com.zpj.mydownloader.ui.widget;
...
//    private static final int WHILE = Color.rgb(255, 255, 255);
    ...
    private static final int BLUE_ONE = Color.parseColor("#06A7FF");
    private static final int WHILE = Color.parseColor("#E6F6FF");
    ...
    private static final float ARC_WIDTH = 40;
    private static final float ARROW_WIDTH = 20;
    private static final float TRI_WIDTH = 20;
    private static final float LOADING_WIDTH = 40;
    ...
    private void init() {
        float temp = getHeight() > getWidth() ? getWidth() / 2.0f : getHeight() / 2.0f;
        radius = temp - temp * OFFSET / RADIUS - temp * ELASTICITY_STEP / RADIUS - 6;
        x = getPaddingLeft() + getWidth() / 2.0f;
        y = getPaddingTop() + getHeight() / 2.0f;
