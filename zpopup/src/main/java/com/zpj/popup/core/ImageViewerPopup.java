        ...
        pager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                ...
                if (srcViewUpdateListener != null) {
                    srcViewUpdateListener.onSrcViewUpdate(ImageViewerPopup.this, i);
                }
            }
        });
...
//        if (isInfinite) pager.setOffscreenPageLimit(urls.size() / 2);
    ...
    public void doShowAnimation() {
        ...
        if (srcView == null) {
            ...
            ImageViewerPopup.super.doAfterShow();
            if (customView != null)
    ...
    public ImageViewerPopup<T> setXPopupImageLoader(XPopupImageLoader<T> imageLoader) {
     ...
     * @return
     */
    public ImageViewerPopup<T> isShowPlaceholder(boolean isShow) {
     ...
     * @return
     */
    public ImageViewerPopup<T> isShowIndicator(boolean isShow) {
     ...
     * @return
     */
    public ImageViewerPopup<T> isShowSaveButton(boolean isShowSaveBtn) {
        this.isShowSaveBtn = isShowSaveBtn;
        return this;
    }

    public ImageViewerPopup<T> isInfinite(boolean isInfinite) {
        this.isInfinite = isInfinite;
        return this;
    }

    public ImageViewerPopup<T> setPlaceholderColor(int color) {
        this.placeholderColor = color;
        return this;
    }

    public ImageViewerPopup<T> setPlaceholderRadius(int radius) {
        this.placeholderRadius = radius;
        return this;
    }

    public ImageViewerPopup<T> setPlaceholderStrokeColor(int strokeColor) {
    ...
    public ImageViewerPopup<T> setSrcView(ImageView srcView, int position) {
