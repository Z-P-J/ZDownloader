...
public class ZPopup {
    ...
    public static AttachListPopup<String> attachList(View view) {
        return new AttachListPopup<>(view);
    }

    public static <T> AttachListPopup<T> attachList(View view, Class<T> clazz) {
        return new AttachListPopup<>(view);
    }
