 ...
 */
@Keep
public class DownloadMission extends BaseConfig<DownloadMission> {
    ...
    private final transient Runnable progressRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (getEnableNotification() && getNotificationInterceptor() != null) {
                getNotificationInterceptor().onProgress(getContext(), DownloadMission.this, getProgress(), false);
            }
        }
    };
...
//        done = length;
    ...
    public synchronized DownloadMission addListener(MissionListener listener) {
        ...
        Observable.create(
                new ObservableOnSubscribe<Object>() {
                    ...
                    public void subscribe(@io.reactivex.annotations.NonNull ObservableEmitter<Object> emitter) throws Exception {
                        String json = getGson().toJson(DownloadMission.this);
