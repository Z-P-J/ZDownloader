...
public class Config<T extends Config<T>> implements Serializable {
    ...
    * */
    ...
    public Config(Config config) {
        ...
        this.setConnectOutTime(config.getConnectOutTime());
        this.setCookie(config.getCookie());
        ...
        this.setRetryCount(config.getRetryCount());
        this.setRetryDelayMillis(config.getRetryDelayMillis());
